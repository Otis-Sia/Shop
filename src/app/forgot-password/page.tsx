      ...
      <div className="w-full max-w-[520px] bg-surface border-2 border-on-background shadow-[4px_4px_0px_0px_var(--color-on-surface)]">
        ...
        <div className="bg-on-background text-background p-8 md:p-10">
          <Link href="/" className="inline-block mb-6 flex items-center gap-2">
            <Image src="/Logo.svg" alt="Logo" width={40} height={40} className="w-auto h-10 invert hue-rotate-180 dark:invert-0 dark:hue-rotate-0" style={{ width: 'auto', height: 'auto' }} />
            <Image src="/name.svg" alt="JUJ4" width={100} height={40} style={{ width: 'auto', height: 'auto' }} className="w-auto h-6 invert hue-rotate-180 dark:invert-0 dark:hue-rotate-0" />
          </Link>
