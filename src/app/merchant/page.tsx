  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-primary-container text-on-surface p-6 border-4 border-on-surface shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          <h3 className="font-headline-sm font-bold uppercase mb-2">Total Products</h3>
          <p className="text-4xl font-black">{stats.products}</p>
        </div>

        <div className="bg-secondary-container text-on-surface p-6 border-4 border-on-surface shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          <h3 className="font-headline-sm font-bold uppercase mb-2">Total Orders</h3>
          <p className="text-4xl font-black">{stats.orders}</p>
        </div>

        <div className="bg-surface text-on-surface p-6 border-4 border-on-surface shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
