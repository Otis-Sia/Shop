    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-surface">
        <div className="text-center">
          <div className="w-12 h-12 border-4 border-on-surface/20 border-t-primary-container rounded-full animate-spin mx-auto mb-6"></div>
    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-surface">
      ...
      <aside className="w-full md:w-64 bg-on-surface text-surface dark:bg-surface-container-low dark:text-on-surface flex flex-col border-b md:border-b-0 md:border-r border-outline/20 shrink-0 transition-colors">
        ...
        <nav className="p-2 md:p-4 flex flex-row md:flex-col overflow-x-auto md:space-y-4 font-body-lg font-bold hide-scrollbar">
          ...
          <Link href="/admin/analytics" className="flex items-center gap-2 md:gap-3 p-3 hover:bg-surface hover:text-on-surface dark:hover:bg-surface-container-high dark:hover:text-primary-container rounded-lg transition-colors rounded-none shrink-0">
