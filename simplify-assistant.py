...
filename = 'src/app/admin/products/components/ProductAIAssistant.tsx'
...
start_logic_str = "  const handleAIAnalyze = async () => {"

start_idx = content.find(start_logic_str)
if start_idx != -1:
    ...
    print("Could not find start logic block")
